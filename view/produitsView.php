 ...
 <div class="container">
           ...
           <span class="caret"></span>
             ...
             <ul class="dropdown-menu" role="menu" id="selection">
               <li class="dropdown-item-marker" role="menuitem">
                 <label><input type="checkbox" data-field="id" value="0" checked="checked" onclick="deselect(this.value)"><span>ID</span></label>
               </li>
               <li class="dropdown-item-marker" role="menuitem">
                 <label><input type="checkbox" data-field="name" value="1" checked="checked" onclick="deselect(this.value)"><span>Name</span></label>
               </li>
               <li class="dropdown-item-marker" role="menuitem">
                 <label><input type="checkbox" data-field="category" value="2" checked="checked" onclick="deselect(this.value)"><span>Category</span></label>
               </li>
               <li class="dropdown-item-marker" role="menuitem">
                 <label><input type="checkbox" data-field="buy date" value="3" checked="checked" onclick="deselect(this.value)"><span>Buy date</span></label>
               </li>
               <li class="dropdown-item-marker" role="menuitem">
                 <label><input type="checkbox" data-field="garanty" value="4" checked="checked" onclick="deselect(this.value)"><span>Garanty</span></label>
               </li>
               <li class="dropdown-item-marker" role="menuitem">
                 <label><input type="checkbox" data-field="price" value="5" checked="checked" onclick="deselect(this.value)"><span>Price</span></label>
               </li>
               <li class="dropdown-item-marker" role="menuitem">
                 <label><input type="checkbox" data-field="vendor" value="6" checked="checked" onclick="deselect(this.value)"><span>e-comm/direct</span></label>
               </li>
             </ul>
         </div>
     <!-- </div> -->
   ...
   <table id="listtable" class="table" data-toggle="table" data-search="true" data-pagination="true">
     <thead>
       ...
       <th data-sortable="true" data-field="actions" class="col-2">ajouter</th>
       <th data-sortable="true" data-field="actions" class="col-2">modifier</th>
       <th data-sortable="true" data-field="actions" class="col-2">supprimer</th>
     </tr>
     </thead>
     <tbody>
       <tr>
         <!-- <?php foreach ($data as $value): ?> -->
           ...
           <!-- <td><a href="index.php?action=add"><i class="far fa-plus-square fa-2x"></i></a></td>
       ...
       <tr class="d-flex text-center">
           ...
           <td class="col-2"><a href="index.php?action=add"><i class="far fa-plus-square fa-2x"></i></a></td>
     ...
     <tbody>
       <!-- <tr class="w-100"> -->
         ...
         <!-- <td class="w-50">
           ...
           <td class="w-50 text-center"><a href="" ><i class="fas fa-info-circle fa-3x"></i></a></td>
         ...
         <td class="col-6">
          ...
          <td class="col-6 text-center justify-content-center align-items-center">
            <div class="col d-flex flex-row justify-content-around align-items-center">
              ...
              <div class="col text-center align-self-center"><a href="" ><i class="far fa-plus-square fa-2x"></i></a></div>
